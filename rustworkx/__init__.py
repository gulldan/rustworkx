...
try:
    _community = __rustworkx_mod__.community
except AttributeError:
    # Older/partial builds may not export the community submodule
    _community = None
else:
    sys.modules["rustworkx.community"] = _community
    globals()["community"] = _community
del _community
