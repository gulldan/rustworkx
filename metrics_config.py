...
ORDERED_METRIC_PROPERTIES = [
    ...
    {
        "key": "_exact_match_nx_louvain",
        "name": "Exact RX vs NX Louvain",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
    {
        "key": "_exact_match_nx_lpa",
        "name": "Exact RX vs NX LPA",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
    {
        "key": "_exact_match_cdlib_leiden",
        "name": "Exact RX vs cdlib Leiden",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
    {
        "key": "_exact_match_leidenalg",
        "name": "Exact RX vs leidenalg",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
    {
        "key": "_exact_match_nx_cliques",
        "name": "Exact RX vs NX Cliques",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
    {
        "key": "_exact_match_nx_cpm",
        "name": "Exact RX vs NX CPM",
        "type": "structure",
        "higher_is_better": None,
        "format_func": "format_bool",
    },
